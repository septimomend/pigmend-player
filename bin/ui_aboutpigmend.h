...
public:
    ...
    void setupUi(QDialog *AboutPigmend)
    {
        ...
        okButton->setGeometry(QRect(370, 250, 51, 29));
        ...
        description->setGeometry(QRect(30, 140, 381, 101));
    ...
    {
        AboutPigmend->setWindowTitle(QApplication::translate("AboutPigmend", "Dialog", nullptr));
